...
if(isset($_POST['placeOrder'])){
    if(!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['phone']) && !empty($_POST['address']) && $_POST['qty']>0){
        ...
        if($checkOut->finalCheckOut($_POST['name'],$_POST['email'],$_POST['phone'],$_POST['address'],$_POST['qty'],$_GET['buyNow'])){
            ...
            $Error = "<p class='h3 text-danger'>Something is wrong to inserting into database<p>";
        }
    }else{
        $Error = "<p class='h3 text-danger'>You have to fill your all details or Quantity can't be 0 or less<p>";
    }
}
?>
<!DOCTYPE html>
                ...
                <div class="col-lg-4">
                    <div class="checkout-inner">
                        <div class="checkout-summary">
                            ...
                            <h1>Cart Total</h1>
                            <p>Product Name<p class="text-dark font-weight-bold"> <?php echo $pd->getName(); ?> </p></p>
                            <p class="sub-total">Sub Total<span><?php echo $pd->getPrice(); ?></span></p>
                            <p class="ship-cost">Shipping Cost<span>50 BDT</span></p>
                            <p>Quantity: <span><input type="number" value="1" name="qty" class="w-25"></span></p>
                            <h2>Total<span>
                            
                            <?php
                            echo (int)$pd->getPrice()+50; ?></span></h2>
                        </div>
